...
const MotionAppScreenHeader = motion(AppScreenHeader);
const MotionAppScreenBody = motion(AppScreenBody);
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreenTitle>Invite people</AppScreenTitle>
        <AppScreenSubtitle>
...
function StocksScreen({
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreenTitle>Stocks</AppScreenTitle>
        <AppScreenSubtitle>March 9, 2022</AppScreenSubtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
...
function InvestScreen({
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreenTitle>Buy $LA</AppScreenTitle>
        <AppScreenSubtitle>
    ...
    <>
      ...
      >
        {features.map((feature, featureIndex) => (
          ...
          >
            <div className="relative transform overflow-hidden rounded-2xl bg-neutral-900 px-5 py-6">
              ...
              <PhoneFrame className="relative mx-auto w-full max-w-[366px]">
                <feature.screen custom="" animated={true} />
              </PhoneFrame>
              <div className="absolute inset-x-0 bottom-0 bg-neutral-900/95 p-6 backdrop-blur sm:p-10">
                <feature.icon className="h-8 w-8" />
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-4xl md:text-6xl lg:7xl bg-gradient-to-b from-zinc-100 clash via-zinc-300 to-red-400 bg-clip-text text-transparent">
